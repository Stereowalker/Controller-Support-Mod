...
public class PaperDollOptionsScreen extends Screen {
	...
	public void addOption(int index, DollType getter) {
		...
		this.addRenderableWidget(Button.builder(getter.getDisplayText().append(" : ").append(CommonComponents.optionStatus(settings.paperDoll.show.get(getter))), (p_212984_1_) -> {
	...
	public void addOption(int index, boolean getter, Consumer<Boolean> setter, MutableComponent text) {
		boolean left = index%2 == 0;
		int position = index / 2;
		this.addRenderableWidget(Button.builder(text.append(" : ").append(CommonComponents.optionStatus(getter)), (p_212984_1_) -> {
